...
public class MoveRueda : MonoBehaviour
{
    ...
    /*void Movement()
    {
        ...
        Vector3 movement = new Vector3(_input.x, 0, _input.y).normalized;
        // Aplicar fuerza hacia adelante para mover el robot
    ...
    void AnimRueda()
    { 
        // Hacer que la rueda gire en base al movimiento
        if (rueda != null)
        {
